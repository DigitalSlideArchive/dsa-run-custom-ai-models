...
DEVICE = "cuda:0"  # Can be changed to a specific hardware device, e.g., "cuda:0" for GPU
MODEL_TYPE = "vit_t"  # The type of model to use, e.g., "vit_h"
